...
# Création base vide
touch pixelbay-sqlite.db

# Création des dossiers
mkdir -p sqlite-queries/0.00-init
cd sqlite-queries || exit

# Création du schéma + données
cat <<'EOF' > 0.00-init/0.01-create_schema_and_data.sql
-- Magasins
...
echo "✅ Script Pixelbay prêt ! Fichier SQL généré dans pixelbay-sqlite/0.00-init/0.01-create_schema_and_data.sql"
